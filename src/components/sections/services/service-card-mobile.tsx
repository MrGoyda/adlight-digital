  ...
  return (
    <div className="sticky top-20 mb-4 last:mb-0">
      <div 
        ...
        style={{ 
            borderColor: `${data.hex}30` // Динамический цвет бордера (30 = ~20% прозрачности)
        }}
      >
        {/* ФОНОВОЕ СВЕЧЕНИЕ (НОВОЕ) */}
        <div 
        ...
        <div 
            ...
            style={{ backgroundColor: data.hex }} // Используем hex для надежности
        />
