...
export const ProcessFeed = ({ activeStepId, setActiveStepId }: Props) => {
  ...
  return (
    <div className="flex flex-col gap-12 lg:gap-40 py-10 lg:py-20 relative pb-[40vh]">
      {/* GLOBAL LINE (DESKTOP) */}
...
const ProcessStepItem = ({ step, isActive, setRef, isLast }: any) => {
  return (
    <div ref={setRef} className="relative group min-h-[30vh]">
       ...
       <div className="hidden lg:block pl-32 relative">
         ...
         {/* 2. ACTIVE BEAM (ЛУЧ) */}
         {/* FIX: Уменьшили до +12rem.
            FIX: Добавили mask-image, чтобы конец луча растворялся и не выглядел обрубленным 
         */}
         <div 
           className={cn(
